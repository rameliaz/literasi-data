...
::: {.callout-tip}
### Baris itu granular
Baris idealnya mewakili informasi paling rendah levelnya dan paling detail — bukan ringkasan atau subtotal. Kita akan lihat kenapa ini penting sebentar lagi.
:::
...
## 🧩 Latihan mandiri: membaca referensi sel

::: {.callout-warning}
### Kerjakan sendiri (5 menit, tidak dinilai)
Perhatikan potongan tabel berikut:
...
Tanpa membuka spreadsheet, jawab di kertas/catatan Anda:

1. Formula apa yang menghasilkan **rata-rata usia** ketiga partisipan?
2. Sel apa yang berisi **skor tertinggi**?
3. Tuliskan formula `=AVERAGE()` untuk skor menggunakan referensi rentang (bukan menyebut satu-satu sel B2, B3, B4).
:::

::: notes
Beri waktu 2-3 menit, lalu minta 1-2 mahasiswa membacakan jawabannya. Jawaban: 1) =AVERAGE(B2:B4), 2) C4, 3) =AVERAGE(C2:C4).
:::
