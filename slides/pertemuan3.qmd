...
::: {.incremental}
* **Portal data terbuka** — antarmuka web yang dirancang khusus untuk berbagi dataset yang bisa dipakai ulang (mis. *Open-Source Psychometrics Project*, [Open Science Framework (OSF)](https://osf.io/)).
